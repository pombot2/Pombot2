...
# ==========================================================
# CONFIG & AUTHENTICATION (Declared at Top as Shown)
# ==========================================================
...
# --- Database Initialization & 30-Day License Timer ---
def init_db():
    ...
    if c.fetchone()[0] == 0:
        ...
        # Start exactly 30 days from now
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Fixed Table Layout — No Collapsing Buttons */
    table {
        width: 100%;
...
# --- Canvas & Live Countdown Script Engine ---
CANVAS_SCRIPT = """
...
# --- 1. Dashboard Overview (With Dynamic 30-Day Live Timer) ---
...
async def admin_dashboard(request: Request):
    ...
    # Initial static fallback before JS tick
        ...
        <div class="main-wrapper">
            ...
            <div class="dashboard-container">
                <div class="stats-grid">
                    ...
                    <!-- 30 Days Dynamic License Countdown Card -->
