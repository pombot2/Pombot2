...
class BotManager:
    ...
    async def _run_bot(self, token: str):
        try:
            ...
            self.status = "Running"
            logger.info("Bot engine is now Running.")
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Dynamic Online / Offline Status Badges */
    .status-badge-online {
        font-family: 'Orbitron', sans-serif;
        font-size: 11px;
        letter-spacing: 1px;
    ...
    /* Ultra-Smooth Hardware-Accelerated Sliding Sidebar */
    .sidebar {
        position: fixed;
...
# Helper to render the dynamic badge based on token and active running state
...
# Sidebar with "Plan Buttons" updated
        ...
        <div class="main-wrapper">
            <div class="login-container">
                <div class="login-card">
                    ...
                    <!-- Developer Link (Login Page Only) -->
...
# --- 4. Category: Message & Buttons Settings ---
...
# --- 5. Category: Plan Buttons (Renamed from 17 VIP Packs) ---
