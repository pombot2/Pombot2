    ...
    if c.fetchone()[0] == 0:
        ...
        default_details = {
            str(i): {
                ...
                "desc": "HOUSEWIFE IN HOME WITH HUSBAND OR HIS BROTHER" if i == 0 else "Full high-speed streaming bundle."
            } for i in range(17)
        }
...
# --- Keyboard Builders with Dynamic Prices ---
def build_main_keyboard(cfg):
    keyboard = []
    # 17 Green Buttons with price displayed directly on each button
    for idx in range(17):
        ...
        # Label shows both button text and price
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Step 1: Click Green Button -> Show Videos + Pack Description Card
        ...
        # Card matching top part of screenshot
        preview_text = (
            f"━━━━━━━━━━━━━━━━━━\n"
            f"🎀 *Pack*\n"
            f"{pack_name}\n\n"
    ...
    # Step 2: Click "Buy Now" -> Show Auto-Generated Payment QR Page
        ...
        # Main payment page matching bottom part of screenshot
        payment_text = (
            f"━━━━━━━━━━━━━━━━━━\n"
            f"💎 *Payment*\n\n"
            f"🎀 *{pack_name}*\n"
...
# --- 5. Plan Buttons (Editable Name, Price, Description, Videos) ---
